            ...
            success: function(result)
            {
                if(result.status ==1){
                    ...
                    if(result.tabId =='Class-Wise-Examination'){
                        ...
                        $('.export-classwise-resultsheet').html('<a href="'+dataUrl+'"><img src="../img/print.png" alt="print report"></a>');
                    ...
                    if(result.tabId =='Top-Position'){
                        ...
                        var str_position = JSON.stringify(position);
                        var dataUrl = exportUrl+"?fk_class_id="+classId+"&fk_group_id="+groupId+"&fk_section_id="+sectionId+"&fk_exam_type="+examType +'&position=' +  str_position;
                        $('.top-position').html('<a href="'+dataUrl+'"><img src="../img/print.png" alt="print report"></a>');
