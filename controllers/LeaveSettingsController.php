...
use app\models\search\LeaveSettingsSearch;
...
class LeaveSettingsController extends Controller
{
    ...
    {    
        $searchModel = new LeaveSettingsSearch();
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new LeaveSettings",
                ...
                return [
                    ...
                    'title'=> "Create new LeaveSettings",
                    'content'=>'<span class="text-success">Create LeaveSettings success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing LeaveSettings model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing LeaveSettings model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    public function actionLeaveCounter(){
        $this->render('leave-counter');
    }
} //end of main class
