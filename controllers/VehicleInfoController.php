...
use app\models\search\VehicleInfoSearch;
...
class VehicleInfoController extends Controller
{
    ...
    {    
        $searchModel = new VehicleInfoSearch();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new VehicleInfo",
                    'content'=>'<span class="text-success">Create VehicleInfo success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing VehicleInfo model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing VehicleInfo model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
