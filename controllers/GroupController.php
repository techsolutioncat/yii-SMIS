...
class GroupController extends Controller
{
    ...
    /**
     * Displays a single RefGroup model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing RefGroup model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing RefGroup model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RefGroup model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the RefGroup model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RefGroup the loaded model
