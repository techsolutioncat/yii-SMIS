...
return strtoupper($data->user->first_name ." ".$data->user->middle_name  . " " . $data->user->last_name);
    ...
    <?php Pjax::end() ?>
    <?php $form = ActiveForm::begin(['id'=>'generate-monthly-challan-form','action'=>Url::to(['fee/generate-monthly-challan'])]);?>

     <?php ActiveForm::end(); ?>
     <?= Html::a('Monthly Challan', ['fee/generate-monthly-challan'],['class'=>'btn green-btn pull-right montly-challan-btn','id'=>'monthly-challan-generator'])?>
     <?= Html::a('Next Month Challan', ['fee/generate-next-month-challan'],['class'=>'btn green-btn pull-right montly-challan-btn','id'=>'monthly-challan-generator'])?>
