    ...
    <div class="fs_student shade">
        <div class="row" style="   display: inline-block;">
            <div class="logo" style="margin-left:8px !important; margin-right: 8px !important;margin-top:-20px ">
                <img src="http://159.69.146.118/khawla/uploads/khawlabaner.png" alt="DMC" style=" width: 98%;">
            </div>
            <div class="dmc-logo left" style="width:250px; box-shadow: none; float: left; margin-left: 25px; margin-bottom: 0px; margin-top: -50px">
                <div class="thumb right">
                    ...
                    <div style="width:100px; float:none; box-shadow: none;margin-top: 20px">
        ...
        <div style="width:90%; margin-left:5%">
            ...
            <div class="table-dmc col-12">
              ...
              <thead >
                    <tr style="background: #fff;color: #2e3c54; border:1px solid black">
                        <th style=";border:1px solid black">S.No</th>
                        <th style="border:1px solid black"><?=Yii::t('app','Subject')?></th>
                        <th style="border:1px solid black"><?=Yii::t('app','Total Marks')?></th>
                        <th style="border:1px solid black"><?=Yii::t('app','Obtained Marks')?></th>
                        <th style="border:1px solid black"><?=Yii::t('app','Percentage')?></th>
                        <th style="border:1px solid black"><?=Yii::t('app','Grade')?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    foreach($query as $sub_data){
                        ...
                        ?>
                        <tr style=" border:1px solid black;background: #fff;">
                            <td style="text-align:center;border:0.5px solid black"><?=$i?></td>
                            <td style="text-align:left;border:0.5px solid black"><?= ucfirst($sub_data['subject'])?></td>
                            <td style="text-align:center;border:0.5px solid black"><?= $sub_data['total_marks']?></td>
                            <td style="text-align:center;border:0.5px solid black"><?= $sub_data['marks_obtained']?></td>
                            <td style="text-align:center;border:0.5px solid black"><?= $subject_percentage?> % </td>
                            <td style="text-align:center;border:0.5px solid black"><?= Yii::$app->common->getLegends($subject_percentage)?> </td>
                        </tr>
                        <?php
                    ...
                    <tfoot>
                    <tr >
                        <th class="tt_l" colspan="3" style="text-align: right;background: #6dd8a0; padding: 1px;font-size: 5px;text-align: center;color: #000;">Total <?=$total_marks?></th>
                        <th class="tt_pls" style="background: #2e3c54;  padding: 1px;font-size: 5px;text-align: center;color: #fff;"><?=$total_obt_marks?></th>
                        <th class="tt_prcnt" style=" background: #404040;  padding: 1px;font-size: 5px;text-align: center;color: #fff;"><?=$overall_percentage?>%</th>
                        <th class="tt_prcnt" style=" background: #404040;  padding: 1px;font-size: 5px;text-align: center;color: #fff;"><?=Yii::$app->common->getLegends($overall_percentage)?></th>
                    </tr>
                    </tfoot>
                </table>
				 ...
				 <div class="logo" style="margin-top:20px !important; margin-left:30px "> 
                <img src="http://159.69.146.118/khawla/uploads/khawla-footer.png" alt="DMC" style=" width: 98%;">
                      </div>
			</div>	
            </div>
        </div>
