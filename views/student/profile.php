                                       ...
                                       <?php
                                        ...
                                        <?php
                                                ...
                                                $query_extrahead = yii::$app->db->createCommand("select fhw.id,fhw.fk_branch_id,fhw.fk_stu_id,fh.title,fhw.payment_received,fcr.arrears from fee_head_wise fhw  
                                                    ...
                                                    where fhw.fk_stu_id=" . $student_id . " and fhw.fk_branch_id=" . Yii::$app->common->getBranch() . " and fh.extra_head=1 and fhw.fk_fee_particular_id IS NULL and ftd.challan_no = '" . $getChalan['challan_no'] . "' and fhw.created_date like '%".date('Y')."%'")
                                                    ->queryAll();
                                       ?>
                                        <table class="table table-striped">
                                            <thead>
