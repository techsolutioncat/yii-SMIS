...
<div class="reports_wrap form-middle">
    ...
    <div class="bhoechie-tab-menu">
      <div class="list-group"> 
       ...
       <a href="/acadamic" class="list-group-item text-center"> Previous Students Report </a>  
      </div>
    ...
    <ul class="nav nav-tabs">
    <li class="active">
    <a data-toggle="tab" href="#attendance1">Over All Report</a>
    </li>
    <li>
    <a data-toggle="tab" href="#attendance2">Class Wise Report</a>
    </li>
    <li>
    <a data-toggle="tab" href="#attendance3">Group Wise Report</a>
    </li>
    <li>
    <a data-toggle="tab" href="#attendance4">Section Wise Report</a>
    </li>
    <li>
    <a data-toggle="tab" href="#attendance5">Date Wise Report</a>
    </li>
    <li>
    <a data-toggle="tab" href="#attendance6">Student Attendance Report</a>
    </li>
    </ul>
    <div class="tab-content">
    ...
    <div id="attendance5" class="tab-pane fade">
        <div class="attend-tab-inn">
            ...
            <?php ActiveForm::end(); ?>
            <input type="submit" name="submits" id="submitcls" class="submitcls btn green-btn" data-url="<?php echo Url::to(['reports/show-cls'])?>" style="display: none;margin-top:28px;"  />
            </div>
    ...
    <!-- attendance 6 -->
    <div id="attendance6" class="tab-pane fade">
    <div class="attend-tab-inn">
    <div class="col-md-3">
                           <label>Class</label>
