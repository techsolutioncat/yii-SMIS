 ...
 ?> 
  <table class="table table-striped">
			...
			<th>Father Name</th>
                            ...
                            $fathername=StudentParentsInfo::find()->where(['stu_id'=>$father])->one();
...
<td><?php echo $fathername->first_name;?></td>
...
where fhw.fk_stu_id=" . $stu_id . " and fhw.fk_branch_id=" . Yii::$app->common->getBranch() . " and fh.extra_head=1 and fhw.fk_fee_particular_id IS NULL and ftd.challan_no = '" . $getChalan['challan_no'] . "'")
                     ->queryAll();
