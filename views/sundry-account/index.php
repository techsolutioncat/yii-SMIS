...
<div class="exam-form free-generator content_col grey-form"> 
	<h1 class="p_title">Sundry Account</h1>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-md-6 col-lg-4 rg_item">
                ...
                ?>
                 ...
                 <input type="hidden" name="" id="passClassUrl" data-url=" <?=Url::to(['/sundry-account/generate-challan-std-list-class'])?>">
    
            </div>
            <div class="col-sm-4 col-md-6 col-lg-4 rg_item">
                <input type="hidden" id="subject-url" value="<?=Url::to(['/sundry-account/generate-challan-std-list-class'])?>">
                <?php
