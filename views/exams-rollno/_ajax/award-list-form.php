        ...
        <table class="table">
            ...
            <?php
                ...
                ?>
                    ...
                    <td>
                        <?=$form->field($model, 'remarks['.$key.']')->textInput(['value'=>(isset($current->remarks))?$current->remarks:''])->label(false)?>
                    </td>
                    </tr>
                    <?php
                    $i++;
		...
		<?php
         if (count($modelExam)>0) {
            ...
            <div class="form-group">
                ...
                ], ['class' => 'teaser btn green-btn', 'id' => 'save-award-list']) ?>
				 <?= Html::a('Generate Roll No.',[
                    'attendance-list',
                    'exam_id'=>$modelExam->id,
                    /*'class_id'=>$modelExam->fk_class_id,
                    'group_id'=>($modelExam->fk_group_id)?$modelExam->fk_group_id:null,
