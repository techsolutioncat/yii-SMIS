...
<div class="col-12 fs_content">
    ...
    <div class="fs_student shade">
        <div class="row" style="   display: inline-block;">
            <div class="logo" style="margin-left:8px !important; margin-right: 8px !important;margin-top:-20px ">
                <img src="http://159.69.146.118/new_islamia/uploads/new_islamia_banner.png" alt="DMC" style=" width: 98%;">
            </div>
            ...
            <div class="table-dmc col-12">
              ...
              <thead >
                    <tr style="background: #fff;color: #2e3c54; border:1px solid black">
                        ...
                        <th style="border:1px solid black"><?=Yii::t('app','Status')?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    foreach($query as $sub_data){
                        ...
                        <tr style=" border:1px solid black;background: #fff;">
                            ...
                            <td style="text-align:left;border:1px solid black"><?= ucfirst($sub_data['subject'])?></td>
                            <td style="text-align:center;border:1px solid black"><?= $sub_data['total_marks']?></td>
                            <td style="text-align:center;border:1px solid black"><?= $sub_data['marks_obtained']?></td>
                            <td style="text-align:center;border:1px solid black"><?= $subject_percentage?> % </td>
  ...
  <?php 
    ...
    ?> 
                    ...
                    <tr >
                        ...
                        <th class="tt_prcnt" style=" background: #404040;  padding: 3px;font-size: 15px;text-align: center;color: #fff;">
  ...
  <?php 
    ...
    ?> 
                ...
                <img src="http://159.69.146.118/new_islamia/uploads/ni_footer.png" alt="DMC" style=" width: 98%;">
                      </div>
			</div>	
            </div>
        </div>
