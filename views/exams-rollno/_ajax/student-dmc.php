    ...
    <div class="col-sm-6 dmc-logo">
        <div class="row">
          <div class="col-sm-3 dm-thumb">
              <img width="250" src="<?= Url::to('@web/uploads/school-logo/danish-logo.jpg').$branch_details->logo?>" alt="DMC">
            </div>
    ...
    <div class="col-sm-12 dmc_tcontent">
        <div class="col-sm-12 dmc_head">
          <p>Detailed Marks Certificate</p>
            <span><?=ucfirst($exam_details->type)?> | <strong style="color:#fff;">Position <b><?=(isset($position))?$position:'N/A'?></b></strong></span>
        </div>
        <div class="table-dmc">
